                    ...
                    <table class="table table-hover datatable">
                        ...
                        <tbody>
                            ...
                            <tr data-status="{{ $copy->status }}" data-book-id="{{ $copy->book_id }}">
                                <td>
                                    <span class="badge bg-secondary">#{{ $copy->copy_id }}</span>
                                </td>
                                <td>
                                ...
                                <td>
                                    @if($copy->status == 'ISSUED' && $copy->currentBorrowing)
                                        ...
                                        <br>
                                        <small class="text-muted">Due: {{ $copy->currentBorrowing->due_date->format('M d, Y') }}</small>
                                    @else
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        @if($copy->status == 'AVAILABLE')
                                        <form action="{{ route('books.copies.destroy', $copy->copy_id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                                    ...
                                    <!-- Edit Copy Modal -->
                                    <div class="modal fade" id="editCopyModal{{ $copy->copy_id }}">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="{{ route('books.copies.update', $copy->copy_id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
