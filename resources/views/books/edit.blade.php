    ...
    <div class="col-lg-8 mx-auto">
        <div class="card shadow">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('books.show', $book->book_id) }}" class="btn btn-sm btn-outline-info">
            ...
            <div class="card-body">
                <form action="{{ route('books.update', $book->book_id) }}" method="POST">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('books.show', $book->book_id) }}" class="btn btn-outline-info">
                                <i class="bi bi-eye me-1"></i> View
                            </a>
        ...
        <div class="card shadow mt-4">
            ...
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <form action="{{ route('books.copies.destroy', $copy->copy_id) }}" 
                ...
                <div class="mt-4">
                    <h6>Add New Copy</h6>
                    <form action="{{ route('books.copies.store', $book->book_id) }}" method="POST" class="row g-3">
                        @csrf
                        <div class="col-md-4">
