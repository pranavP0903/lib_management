    ...
    <div class="col-lg-8 mx-auto">
        <div class="card shadow">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('members.show', $member->member_id) }}" class="btn btn-sm btn-outline-info">
            ...
            <div class="card-body">
                <form action="{{ route('members.update', $member->member_id) }}" method="POST">
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('members.show', $member->member_id) }}" class="btn btn-outline-secondary">
                            <i class="bi bi-arrow-left me-1"></i> Back to Profile
                        </a>
                        <div class="btn-group">
                            <a href="{{ route('members.show', $member->member_id) }}" class="btn btn-outline-info">
